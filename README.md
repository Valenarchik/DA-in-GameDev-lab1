...
Решил еще раз меньшить batch_size и buffer_size в 10раз. Когда начал опучение, то сразу заметил некоторые подвисания раз в 4-5секунд, я так предпологаю, что это как раз подвидение неких итогов, они стали проходить чаще. При этом настолько сильное уменьшение плохо сказалось на обучении, оно стало происходить дольше.
